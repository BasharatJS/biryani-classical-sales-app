      ...
      {loginSuccess && (
        <div className="fixed inset-0 z-50 bg-background flex items-center justify-center">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-primary mb-2">Login Successful!</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 min-h-[60vh]">
          ...
          <div className="bg-gradient-to-br from-orange-400 to-yellow-500 rounded-2xl p-6 lg:p-8 text-white shadow-xl transform hover:scale-105 transition-transform duration-300">
            <div className="h-full flex flex-col justify-center text-center">
              <div className="mb-6">
                <span className="text-5xl lg:text-6xl mb-4 block animate-bounce">🍛</span>
                <h2 className="text-2xl lg:text-3xl font-bold mb-2">Order Fresh Biryani</h2>
                <p className="text-lg lg:text-xl text-orange-100 mb-6 lg:mb-8">Quick & Easy Ordering</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-orange-600/30 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-orange-100 text-sm">
                    Fresh biryani delivered hot to your doorstep
                  </p>
                </div>
              </div>
            </div>
